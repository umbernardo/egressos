jQuery("#simulation")
  .on("click", ".s-6a968220-49e1-48dc-b06a-13643a3461af .click", function(event, data) {
  ...
  .on("change", ".s-6a968220-49e1-48dc-b06a-13643a3461af .change", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-6a968220-49e1-48dc-b06a-13643a3461af #s-Rectangle_20": {
                      "attributes": {
                      ...
                      "expressions": {
                        "width": "Math.max(364 - 1 - 1 - 2 - 2, 0) + 'px'",
  ...
  .on("focusin", ".s-6a968220-49e1-48dc-b06a-13643a3461af .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
